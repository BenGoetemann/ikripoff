...
.nav-item-wrapper {
  @apply cursor-pointer no-select flex flex-row justify-start items-center gap-3;
...
p {
  @apply leading-[0rem] font-bold text-white;
}
...
.hideText {
  @apply opacity-0 overflow-hidden transition-opacity duration-500;
}
